...
<body>
	...
	<nav class="navbar navbar-expand-lg navbar-dark bg-secondary py-4">
		<div class="container">
			...
			<button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-targe="#navbarNavAltMarkup" aria-controls="navbarNavAltMarkup" aria-expanded="false" aria-label="toggle navigation">
	...
	<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0-alphaq/dist/js/bootstrap.bundle-min-js" crossorigin="anonymous"></script>
</body>
</html>
